...
import { Result, IAnswer } from "src/models";
import { findAssessmentResult } from "src/store/assessment-result.actions";
...
class AssessmentResultPage extends React.Component<AssessmentPageProps, IAssessmentPageState> {
    ...
    public componentDidMount() {
        ...
        findAssessmentResult(assessmentId)
            .then(result => {
                Result.match(
                    result,
                    value => this.setState({
